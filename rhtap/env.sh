...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/jktjz0o3h-dotnet-basic-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-q5trn.q5trn.sandbox2935.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-q5trn.q5trn.sandbox2935.opentlc.com}
